...
Following my post on [Encodings and Unicode]({{< ref "/posts/2022-04-15.md" >}}) it is now time to talk about i18n with [GNU gettext](https://www.gnu.org/software/gettext/). We will look at i18 and l10n in general and then talk about how `gettext` can make our live as programmers very easy.
